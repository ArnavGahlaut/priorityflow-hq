...
function Page() {
  ...
  async function load() {
    try {
      const res = await fetch("https://priorityflow-api.onrender.com/api/admin/rules", {
  ...
  async function toggleRule(id: string) {
    const res = await fetch(
      `https://priorityflow-api.onrender.com/api/admin/rules/${id}/toggle`,
      {
        method: "PATCH",
        headers: {
  ...
  async function updateRule(
    ...
    const res = await fetch(`https://priorityflow-api.onrender.com/api/admin/rules/${id}`, {
      method: "PATCH",
      headers: {
